 ...
 */
@ConvertAsProperties(dtd = "-//ibfb.germplasmlist.core//nurserySelection//EN",
autostore = false)
@TopComponent.Description(preferredID = "nurserySelectionTopComponent",
iconBase="ibfb/germplasmlist/images/sel.png", 
persistenceType = TopComponent.PERSISTENCE_NEVER)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "ibfb.germplasmlist.core.nurserySelectionTopComponent")
...
public final class nurserySelectionTopComponent extends TopComponent {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jLabel1.text")); // NOI18N
        jLabel1.setAutoscrolls(true);

        jTextFieldListName.setText(org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jTextFieldListName.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jButtonSave, org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jButtonSave.text")); // NOI18N
        jButtonSave.setToolTipText(org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jButtonSave.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jLabel4.text")); // NOI18N

        jTextFieldDescription.setText(org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jTextFieldDescription.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jLabel2.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabelEntries, org.openide.util.NbBundle.getMessage(nurserySelectionTopComponent.class, "nurserySelectionTopComponent.jLabelEntries.text")); // NOI18N
        ...
        jTableEntries.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TID SOURCE", "OCC SOURCE", "ENTRY SOURCE", "SELECTION", "DESIG SOURCE", "ENTRY", "GENERATED"
            }
        ) {
...
private int findColumn(String col) {
    ...
    private void saveListIntoDB() {
        ...
        List<Listdata> dataList = new ArrayList<Listdata>();
         ...
         int desig = findColumn("GENERATED");
         int entryCD = findColumn("ENTRY");
         int source = findColumn("DESIG SOURCE");
    ...
    public void createSelectionList() {
        ...
        for (int i = 0; i < modeloTemporal.getRowCount(); i++) {
            ...
            String pedigree = modeloTemporal.getValueAt(i, 3).toString();
            int rep = Integer.parseInt(modeloTemporal.getValueAt(i, 5).toString());
            ...
            for (int j = 0; j < data.size(); j++) {
                ...
                this.jTableEntries.setValueAt(modeloTemporal.getValueAt(i, 0), total-1, 0);//TID
                 this.jTableEntries.setValueAt(modeloTemporal.getValueAt(i, 1), total-1, 1);//OCC
                  this.jTableEntries.setValueAt(modeloTemporal.getValueAt(i, 2), total-1, 2);//ENTRY
                   this.jTableEntries.setValueAt(j+1, total-1, 3);//SEL
                    this.jTableEntries.setValueAt(modeloTemporal.getValueAt(i, 3), total-1, 4);//DESIG
                     this.jTableEntries.setValueAt(total, total-1, 5);//ENTRY
                     this.jTableEntries.setValueAt(data.get(j), total-1, 6);//DESIG GENERATED
    ...
    private void ajustaColumnas() {
        ...
        for (int col = 0; col < this.jTableEntries.getColumnCount(); col++) {
         ...
         this.jTableEntries.getColumnModel().getColumn(4).setCellRenderer(tcr2);
          this.jTableEntries.getColumnModel().getColumn(6).setCellRenderer(tcr2);
