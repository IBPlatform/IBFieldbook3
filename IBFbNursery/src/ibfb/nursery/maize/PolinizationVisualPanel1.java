...
public final class PolinizationVisualPanel1 extends JPanel {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jPanel3.border.title"))); // NOI18N

        buttonGroupPolinization.add(jRadioButtonCruzasPares);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonCruzasPares, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonCruzasPares.text")); // NOI18N

        buttonGroupPolinization.add(jRadioButtonCruzasImpares);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonCruzasImpares, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonCruzasImpares.text")); // NOI18N

        buttonGroupPolinization.add(jRadioButtonProbador);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonProbador, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonProbador.text")); // NOI18N

        buttonGroupPolinization.add(jRadioButtonHaploide);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonHaploide, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonHaploide.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jCheckBoxReciprocos, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jCheckBoxReciprocos.text")); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jPanel4.border.title"))); // NOI18N

        buttonGroupDelimitador.add(jRadioButtonDiagonal);
        jRadioButtonDiagonal.setSelected(true);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonDiagonal, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonDiagonal.text")); // NOI18N

        buttonGroupDelimitador.add(jRadioButtonDobleDiagonal);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonDobleDiagonal, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonDobleDiagonal.text")); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jPanel5.border.title"))); // NOI18N

        buttonGroupProbador.add(jRadioButtonDesconocido);
        jRadioButtonDesconocido.setSelected(true);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonDesconocido, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonDesconocido.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonConocido, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonConocido.text")); // NOI18N

        jTextFieldPedigree.setText(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jTextFieldPedigree.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jLabel1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jLabel2.text")); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jPanel1.border.title"))); // NOI18N

        buttonGroupPolinization.add(jRadioButtonRecombinacion);
        org.openide.awt.Mnemonics.setLocalizedText(jRadioButtonRecombinacion, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jRadioButtonRecombinacion.text")); // NOI18N
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jPanel6.border.title"))); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jLabel3.text")); // NOI18N

        jTextFieldStockName.setText(org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jTextFieldStockName.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jLabel4.text")); // NOI18N

        jTextAreaDescription.setColumns(20);
        jTextAreaDescription.setRows(5);
        jScrollPane1.setViewportView(jTextAreaDescription);

        org.openide.awt.Mnemonics.setLocalizedText(jButtonNextStockName, org.openide.util.NbBundle.getMessage(PolinizationVisualPanel1.class, "PolinizationVisualPanel1.jButtonNextStockName.text")); // NOI18N
