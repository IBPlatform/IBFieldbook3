...
//-----------------------------------Study---------------------------
     ...
     * @return <code>true</cide> if found, <code>false</code> if not found
     */
...
//-----------------------------------Tmethod---------------------------
    ...
    /**
     * Gets an Object from database TmsScaleCon
     * of the type TmsScaleCon
     * @param tmsScaleCon
     * @return TmsScaleCon
     */
    ...
    /**
     * Gets an Object of type TmsScaleCon
     * Finding the record by its ID TmsScaleCon in String format
     * @param idTmethod
     * @return TmsScaleCon
     */
   ...
   /**
    ...
    /**
     * Gets an Object from database TmsScaleDis
     * of the type TmsScaleDis
     * @param tmsScaleDis
     * @return TmsScaleDis
     */
    ...
    /**
     * Gets an Object of type TmsScaleDis
     * Finding the record by its ID TmsScaleDis in String format
     * @param idTmethod
     * @return TmsScaleDis
     */
...
//-----------------------------------Users---------------------------
    ...
    /**
     * get ID for logged user according to following parameters from local database
     * USTATUS = 1
...
//------------------------------------------------------------------------------------------------------------
   ...
   public void saveWorkbookNurseryFull(Workbook workbook); 
    ...
    /**
     * Gets a list of observations data for a study. It contains items of 
     * DATAN or DATAC type
